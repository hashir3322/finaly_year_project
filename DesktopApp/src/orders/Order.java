...
public class Order {
    ...
    public Order(int order_id, String ordered_med_name, int ordered_med_price, int ordered_med_qty, int ordered_med_net, String ordering_pharmacy, String pharmacy_name, String order_status) {
